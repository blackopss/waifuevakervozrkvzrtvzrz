...
client.on("message", message => {
 if (message.content === `+help`) {
  const embed = new Discord.RichEmbed() //by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
      ...
      .setDescription(`
${prefix}play ⇏ To play a song with name or link of it
${prefix}skip ⇏ To skip the corrent song
${prefix}pause ⇏ To pause the corrent song
${prefix}resume ⇏ To resume the song
${prefix}vol ⇏ To change the volume from 0 to 100
${prefix}stop ⇏ To make the bot leave the voice channel
${prefix}np ⇏ To know the corrent song
${prefix}queue ⇏ To see the queue
 `)//by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
